...
//		dyeChatMap.put(DyeColor.SILVER, ChatColor.GRAY);
	...
	private static Map<ChatColor, String> chatRaw;
	static
	{
		chatRaw = Maps.newHashMap();
		chatRaw.put(ChatColor.BLACK, "&0");
		chatRaw.put(ChatColor.DARK_BLUE, "&1"); //
		chatRaw.put(ChatColor.DARK_GREEN, "&2");
		chatRaw.put(ChatColor.DARK_AQUA, "&3");
		chatRaw.put(ChatColor.DARK_RED, "&4"); //
		chatRaw.put(ChatColor.DARK_PURPLE, "&5");
		chatRaw.put(ChatColor.GOLD, "&6");
		chatRaw.put(ChatColor.GRAY, "&7");
		chatRaw.put(ChatColor.DARK_GRAY, "&8");
		chatRaw.put(ChatColor.BLUE, "&9");
		chatRaw.put(ChatColor.GREEN, "&a");
		chatRaw.put(ChatColor.AQUA, "&b");
		chatRaw.put(ChatColor.RED, "&c");
		chatRaw.put(ChatColor.LIGHT_PURPLE, "&d");
		chatRaw.put(ChatColor.YELLOW, "&e");
		chatRaw.put(ChatColor.WHITE, "&f");
	}
	public static String chatToRaw(ChatColor clr)
	{
		if (chatRaw.containsKey(clr))
			return chatRaw.get(clr);
		return "&c";
	}
...
//		dyeHexMap.put(DyeColor.SILVER, "#a0a7a7");
	...
	public static Color dyeToColor(DyeColor color){
		return hexToColor(chatToHex(dyeToChat(color)));
	}
}